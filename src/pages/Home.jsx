    ...
    <>
      ...
      <main>
        ...
        <section id="connectors" className="section-narrow reveal">
          ...
          <Form.Control className="connector-search" type="search" value={connectorQuery} onChange={(event) => setConnectorQuery(event.target.value)} placeholder="Search connectors, e.g. MySQL" aria-label="Search connectors" />
        ...
        <section className="section-narrow reveal">
          ...
          <Table className="comparison-table" responsive>
            <thead>
              <tr>
                <th></th>
          ...
          <div className="contact-layout">
            ...
            <div className="contact-content">
              ...
              <Form className="contact-form" action="mailto:hello@datarheo.io" method="post" onSubmit={handleContactSubmit} >
                ...
                <Form.Control as="textarea" name="message" placeholder="How can we help?" rows={4} required/>
